...
function css() {
  ...
  return gulp.src(['styles/**/*.css', 'fonts/**/*.css'])
    .pipe(plumber())
...
function fonts() {
  return gulp.src('fonts/**/*.{woff,woff2,ttf,otf}')
...
function watchFiles() {
  ...
  gulp.watch(['styles/**/*.css', 'fonts/**/*.css'], css);
  gulp.watch(['images/**/*.{jpg,png,svg,gif,ico,webp,avif}'], images);
  gulp.watch(['fonts/**/*.{woff,woff2,ttf,otf}'], fonts);
}
